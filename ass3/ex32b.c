...
/*
This program gets a sequence of non-negative whole numbers were the 
first number represents the total numbers in the sequence,
and prints the arithmetic mean and geometric mean of the numbers.
*/
